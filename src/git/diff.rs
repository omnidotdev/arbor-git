...
impl DiffService {
        ...
        old_tree
            ...
            .for_each_to_obtain_tree(new_tree, |change| {
                ...
                let info = match change {
                    Change::Addition { location, entry_mode, id, .. } => DiffChangeInfo {
    ...
    fn is_file_binary(&self, repo: &gix::Repository, old_oid: Option<&str>, new_oid: Option<&str>) -> bool {
            ...
            if current_hunk.is_none() {
                ...
                for ctx_idx in start_context..idx {
                    if ctx_idx < edits.len() {
                        ...
                        if ctx_op == EditOp::Equal && ctx_old < old.len() {
